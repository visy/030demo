...
CFLAGS = -D__far="" -Wall -O3 -s -I. -m68030 -fomit-frame-pointer -fexpensive-optimizations -funroll-loops -ffast-math -fstrength-reduce -fcaller-saves
LDFLAGS = -noixemul -L. 
...
$(EXECUTABLE): $(OBJECTS) p2c.o c2p.o
	$(CC) $(LDFLAGS) $(OBJECTS) p2c.o c2p.o c2p_kalms.o ptplayer.o -o $@ -Lmfloat -lmdouble -lmtransdouble -lmtransfloat
